...
function optimize_problem(N, β0=zeros(N + 1))
    ...
    # anim_callback, finalize_anim = plot_objective_and_gradient_norm(inverse_problem, PlotsBackend())
    anim_callback, finalize_anim = OptimalBath.animate_optimization(inverse_problem, β0, PlotsBackend())
